...
import torch
sys.path.append('../../')
from evaluation.eval_random_simulation.rand_eval_gpu_2 import RandEvalGpu
from evaluation.eval_random_simulation.utility import *


def evaluate_sddpg(pos_start=0, pos_end=199, model_name='SNN_R1_snn', save_dir='../saved_model/',
                   batch_window=10, is_save_result=False, use_cuda=True):
    """
    ...
    w_dir = save_dir + model_name + '_weights_s7.p'
    b_dir = save_dir + model_name + '_bias_s7.p'
    if use_cuda:
